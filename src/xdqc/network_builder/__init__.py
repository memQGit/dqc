...
"""Browser-based editor for authoring xdqc network JSON files.
...
:class:`xdqc.network.NetworkGraph` consumes, so nothing here is imported
...
``import xdqc`` never requires the optional Flask dependency.
"""
