...
Builds a :class:`~xdqc.scheduler.instance.SchedulingInstance` from a
compiled :class:`~xdqc.circuit.circuit.DistributedCircuit` and its
:class:`~xdqc.network.NetworkGraph`. The nominal schedule is a deterministic
...
(:func:`xdqc.circuit.dag.build_annotated_dag`) for operation classification,
