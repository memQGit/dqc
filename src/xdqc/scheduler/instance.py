...
:mod:`xdqc.scheduler.nominal` and
:func:`xdqc.compiler.compile_scheduling_instance`; JSON persistence lives in
:mod:`xdqc.scheduler.instance_serialize`. The schema is versioned and kept
...
class SchedulingInstance:
    ...
    Attributes:
        ...
        instance_id: Deterministic identifier derived from
            ``source_fingerprint``.
        compiler_version: xdqc version that produced the instance.
