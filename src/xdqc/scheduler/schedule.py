...
from xdqc.settings import load_settings
...
class Scheduler:
    ...
    def plot_gantt(
        ...
        *,
        ...
        from xdqc.scheduler.schedule_visualizer import plot_schedule_gantt
    ...
    def to_json(
        ...
        *,
        ...
        :func:`xdqc.scheduler.serialize.schedule_to_json` for the document
        layout.
        ...
        from xdqc.scheduler.serialize import schedule_to_json
...
def _get_algorithm_class(name: str) -> type[BaseScheduler]:
    ...
    if name == "des_link_shortest_duration":
        from xdqc.scheduler.des_link_shortest_duration import (
            DESLinkShortestDurationScheduler,
        )

        return DESLinkShortestDurationScheduler
    if name == "des_link_critical_path":
        from xdqc.scheduler.des_link_critical_path import (
