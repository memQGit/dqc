...
:class:`~xdqc.scheduler.instance.SchedulingInstance` artifacts, preserving
...
from xdqc.compiler import (
    compile_scheduling_instance,
    compute_scheduling_source_fingerprint,
)
from xdqc.scheduler.instance_serialize import (
...
if TYPE_CHECKING:
    ...
    from xdqc.partition.partitioner import NetworkInput, ProgramInput
