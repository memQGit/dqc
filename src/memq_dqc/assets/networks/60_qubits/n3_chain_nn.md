...
60-qubit circuit partitioned across 3 QPUs in a **chain** arrangement, **nearest neighbour** intra-QPU connectivity.
...
Data qubits sit on a 5 x 4 row-major grid with 4-way (up/down/left/right) adjacency. Each communication qubit hangs off a single data qubit on the grid boundary; the attachment points are spread evenly around the perimeter.
