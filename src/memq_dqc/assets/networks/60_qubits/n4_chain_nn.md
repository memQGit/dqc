...
60-qubit circuit partitioned across 4 QPUs in a **chain** arrangement, **nearest neighbour** intra-QPU connectivity.
...
| Spare data qubits | 0 |
| Communication qubits per QPU | QPU0: 2, QPU1: 4, QPU2: 4, QPU3: 2 |
...
Data qubits sit on a 4 x 4 row-major grid with 4-way (up/down/left/right) adjacency. Each communication qubit hangs off a single data qubit on the grid boundary; the attachment points are spread evenly around the perimeter.
