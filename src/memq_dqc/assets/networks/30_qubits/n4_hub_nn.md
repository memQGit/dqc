...
30-qubit circuit partitioned across 4 QPUs in a **hub** arrangement, **nearest neighbour** intra-QPU connectivity.
...
| Circuit qubits | 30 |
| QPUs | 4 |
| Data qubits per QPU | 8 (= ceil(30 / 4)) |
| Total data qubits | 32 |
| Spare data qubits | 2 |
...
* 2 spare data qubits beyond the 30 circuit qubits, because the per-QPU count is rounded up so all QPUs are identical.
