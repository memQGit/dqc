...
_MISSING_FLASK = (
    ...
    'Install it with:  pip install "memq-dqc[builder]"'
)
...
def _parse_args(argv: list[str] | None) -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        ...
        description=(
            "Launch the memq_dqc network builder, a local browser tool for "
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(f"memq_dqc network builder running at {url}")
